...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = RCD_grop.decodeJid(RCD_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let RCD_bot = {
      ...group_sss,
    };
    RCD_bot.chat = RCD_bot.jid = RCD_bot.from = group_sss.id;
    RCD_bot.user = RCD_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    RCD_bot.name = await RCD_grop.getName(RCD_bot.user);
    RCD_bot.userNum = RCD_bot.senderNum = RCD_bot.user.split("@")[0];
    RCD_bot.time = getTime("h:mm:ss a");
    RCD_bot.date = getTime("dddd, MMMM Do YYYY");
    RCD_bot.action = RCD_bot.status = group_sss.action;
    RCD_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
      ...
      .includes(RCD_bot.user);
    RCD_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(RCD_bot.user);
    RCD_bot.fromMe = RCD_bot.isAstro
      ? true
      : areJidsSameUser(RCD_bot.user, _0x33935f);
    if (RCD_bot.action === "remove" && RCD_bot.fromMe) {
      return;
    }
    RCD_bot.RCDBot = [...Astro]
    ...
    ].includes(RCD_bot.chat);
    RCD_bot.isGroup = RCD_bot.chat.endsWith("@g.us");
    if (RCD_bot.isGroup) {
      RCD_bot.metadata = await RCD_grop.groupMetadata(RCD_bot.chat);
      gcs[RCD_bot.chat] = RCD_bot.metadata;
      RCD_bot.admins = RCD_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      RCD_bot.isAdmin = !!RCD_bot.admins.find(
        (_0x859f83) => _0x859f83.id === RCD_bot.user
      );
      RCD_bot.isBotAdmin = !!RCD_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    RCD_bot.kick = RCD_bot.remove = (_0x48f5af = RCD_bot.user) =>
      RCD_grop.groupParticipantsUpdate(RCD_bot.chat, [_0x48f5af], "remove");
    RCD_bot.add = (_0x422af3 = RCD_bot.user) =>
      RCD_grop.groupParticipantsUpdate(RCD_bot.chat, [_0x422af3], "add");
    RCD_bot.promote = (_0x3d0644 = RCD_bot.user) =>
      RCD_grop.groupParticipantsUpdate(RCD_bot.chat, [_0x3d0644], "promote");
    RCD_bot.demote = (_0x37d435 = RCD_bot.user) =>
      RCD_grop.groupParticipantsUpdate(RCD_bot.chat, [_0x37d435], "demote");
    RCD_bot.getpp = async (_0x577c8f = RCD_bot.user) => {
      try {
        return await RCD_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    RCD_bot.sendMessage = async (
      _0x5a0f4b = RCD_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await RCD_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    RCD_bot.sendUi = async (
      _0x107cb3 = RCD_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
    ...
    RCD_bot.error = async (
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        RCD_bot.chat !== RCD_bot.botNumber
      ) {
        await RCD_grop.sendMessage(RCD_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await RCD_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [RCD_bot.user],
          },
          {
    ...
    RCD_bot.send = async (
      ...
      _0xb61629 = "RCD",
      _0x919f26 = "",
      _0x3ccfb1 = RCD_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : RCD_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await RCD_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await RCD_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await RCD_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await RCD_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    RCD_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = RCD_bot.jid
    ) => {
      return await RCD_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    RCD_bot.checkBot = (_0x31c33b = RCD_bot.sender) =>
      [...Astro, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    RCD_bot.botNumber = _0x33935f;
    RCD_bot.bot = _0x56741f ? RCD_grop : {};
    if (global.AstroOfficial && global.AstroOfficial === "yes") {
      return RCD_bot;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("RCDMD");
