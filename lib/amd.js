...
Database:  ${(isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : " Default")}
\t_VARS_
...
<html lang="en"><head>
   ...
   <link rel="icon" type="https://telegra.ph/file/a789a7f2437c053ec829a.jpg" sizes="32x32" href="https://telegra.ph/file/a789a7f2437c053ec829a.jpg">
   <title>𝗥𝗖𝗗 𝗠𝗗</title>
...
body {
   ...
   padding: 0;
   font-family: "Outfit";
   background: linear-gradient(-45deg, black , #10e826, #3f10e8, white);
   background-size: 400% 400%;
...
@keyframes gradient {
 ...
 <body>
  <div class="button-container">
   <h2>RCD MD CONNECT  </h2>
   <a href= "https://wa.link/zqsnc1" class="button"> <span>REAL DEXTER</span> </a> <br>
   <a href= "https://wa.link/vzr273" class="button"> <span>CYBER DEXTER</span> </a> <br>
   <a href= "https://wa.link/zqcpfg" class="button"> <span>KING RAVIYA</span> </a> <br>
   <a href= "https://whatsapp.com/channel/0029Vag1WQFJf05dF0pQeU3u" class="button"> <span>JOIN CHANNEL</span> </a> <br>
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^wasi_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/wasi;;;/gi, "").replace(/Astro;;;/gi, "").replace(/RCD;;;/gi, "").trim();
